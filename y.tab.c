...
static const yytype_uint8 yyprhs[] =
{
      ...
      19,    21,    23,    24,    29,    32,    33,    40,    41,    48,
      49,    59,    60,    72,    73,    78,    82,    86,    90,    94,
      98,   102,   104,   108,   112,   116,   120,   124,   128,   132,
     136
};
...
static const yytype_int8 yyrhs[] =
{
      ...
      -1,    38,    -1,    40,    -1,    46,    -1,    42,    -1,    44,
      -1,    48,    -1,    -1,     9,     6,    36,    32,    -1,     7,
       6,    -1,    -1,     4,     5,     9,     6,    39,    32,    -1,
      -1,     4,     5,    48,     6,    41,    32,    -1,    -1,    12,
      10,    49,    11,    13,    34,     6,    43,    32,    -1,    -1,
      12,    10,    49,    11,    13,    34,    14,    34,     6,    45,
      32,    -1,    -1,     8,     6,    47,    32,    -1,    48,    24,
      48,    -1,    48,    25,    48,    -1,    48,    26,    48,    -1,
      48,    27,    48,    -1,    48,    28,    48,    -1,    10,    48,
      11,    -1,     3,    -1,    48,    15,    48,    -1,    48,    16,
      48,    -1,    48,    17,    48,    -1,    48,    18,    48,    -1,
      48,    19,    48,    -1,    48,    20,    48,    -1,    49,    29,
      49,    -1,    49,    30,    49,    -1,    48,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint16 yyrline[] =
{
       0,   181,   181,   181,   183,   184,   185,   186,   187,   188,
     189,   190,   194,   193,   198,   207,   206,   211,   211,   216,
     216,   224,   224,   233,   232,   242,   249,   256,   263,   270,
     277,   280,   288,   294,   300,   306,   312,   318,   324,   330,
     336
};
#endif
...
{
  "$end", "error", "$undefined", "NUMBER", "PRINT", "WHITESPACE",
  "NEWLINE", "EXIT", "HELP", "STRING", "OBRACE", "CBRACE", "IF", "THEN",
  "ELSE", "GT", "LT", "EQ", "GE", "LE", "NE", "AND", "OR", "EXOR", "ADD",
  "SUB", "MUL", "DIV", "MOD", "ANDAND", "OROR", "$accept", "COMMAND",
  "$@1", "Expression1", "errorPrint", "$@2", "exit", "printString", "$@3",
  "printNumber", "$@4", "ifCondition", "$@5", "ifElseCondition", "$@6",
  "help", "$@7", "E", "CONDITION", 0
};
#endif
...
{
       0,    31,    33,    32,    34,    34,    34,    34,    34,    34,
      34,    34,    36,    35,    37,    39,    38,    41,    40,    43,
      42,    45,    44,    47,    46,    48,    48,    48,    48,    48,
...
{
       2,     0,     0,     1,    31,     0,     0,     0,     0,     0,
       0,     3,     4,     5,     6,     7,     9,    10,     8,    11,
       0,    14,    23,    12,     0,     0,     0,     0,     0,     0,
       0,     0,     0,     2,     2,    30,    40,     0,    25,    26,
      27,    28,    29,    15,    17,    24,    13,     0,     0,     0,
       0,     0,     0,     0,     0,     0,     2,     2,    32,    33,
      34,    35,    36,    37,     0,    38,    39,    16,    18,     0,
      19,     0,     2,     0,    20,    21,     2,    22
};
...
{
      -1,     1,     2,    11,    12,    34,    13,    14,    56,    15,
      57,    16,    72,    17,    76,    18,    33,    19,    37
};
...
{
     -57,     2,    65,   -57,   -57,    22,    29,    41,    56,     0,
      27,   -57,   -57,   -57,   -57,   -57,   -57,   -57,   -57,    54,
       4,   -57,   -57,   -57,    25,     0,     0,     0,     0,     0,
       0,    70,    -2,   -57,   -57,   -57,    39,     1,     6,     6,
     -57,   -57,   -57,   -57,   -57,   -57,   -57,     0,     0,     0,
       0,     0,     0,    71,     0,     0,   -57,   -57,    54,    54,
      54,    54,    54,    54,    65,    31,    31,   -57,   -57,    -5,
     -57,    65,   -57,    77,   -57,   -57,   -57,   -57
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -57,   -28,   -57,   -56,   -57,   -57,   -57,   -57,   -57,   -57,
     -57,   -57,   -57,   -57,   -57,   -57,   -57,    -9,    16
};
...
{
      24,    70,     3,     4,    44,    45,    46,     4,    69,    71,
       9,    32,    53,    31,     9,    73,    36,    38,    39,    40,
      41,    42,    26,    27,    28,    29,    30,    20,    67,    68,
      54,    55,    28,    29,    30,    21,    35,    25,    58,    59,
      60,    61,    62,    63,    74,    36,    36,    22,    77,    26,
      27,    28,    29,    30,    47,    48,    49,    50,    51,    52,
      54,    55,    23,    26,    27,    28,    29,    30,     4,     5,
      65,    66,     6,     7,     8,     9,    43,    10,    26,    27,
      28,    29,    30,    75,    64
};

static const yytype_uint8 yycheck[] =
{
       9,     6,     0,     3,     6,    33,    34,     3,    64,    14,
      10,    20,    11,     9,    10,    71,    25,    26,    27,    28,
      29,    30,    24,    25,    26,    27,    28,     5,    56,    57,
      29,    30,    26,    27,    28,     6,    11,    10,    47,    48,
      49,    50,    51,    52,    72,    54,    55,     6,    76,    24,
      25,    26,    27,    28,    15,    16,    17,    18,    19,    20,
      29,    30,     6,    24,    25,    26,    27,    28,     3,     4,
      54,    55,     7,     8,     9,    10,     6,    12,    24,    25,
      26,    27,    28,     6,    13
};
...
{
       0,    32,    33,     0,     3,     4,     7,     8,     9,    10,
      12,    34,    35,    37,    38,    40,    42,    44,    46,    48,
       5,     6,     6,     6,    48,    10,    24,    25,    26,    27,
      28,     9,    48,    47,    36,    11,    48,    49,    48,    48,
      48,    48,    48,     6,     6,    32,    32,    15,    16,    17,
      18,    19,    20,    11,    29,    30,    39,    41,    48,    48,
      48,    48,    48,    48,    13,    49,    49,    32,    32,    34,
       6,    14,    43,    34,    32,     6,    45,    32
};
...
#line 242 "yacc.y"
    {
    char temp[20];
    sprintf(temp, "t%d = t%d + t%d", ++tempCount, (yyvsp[(1) - (3)]), (yyvsp[(3) - (3)]));
    addIntermediateCode(temp);
    (yyval) = tempCount; // Store the result in the current tempCount
    tempValues[tempCount] = tempValues[(yyvsp[(1) - (3)])] + tempValues[(yyvsp[(3) - (3)])]; // Compute the result
}
    break;
...
#line 249 "yacc.y"
    ...
    addIntermediateCode(temp);
    (yyval) = tempCount;
    tempValues[tempCount] = tempValues[(yyvsp[(1) - (3)])] - tempValues[(yyvsp[(3) - (3)])];
}
    break;
...
#line 277 "yacc.y"
    {
    (yyval) = (yyvsp[(2) - (3)]); // Propagate the value inside parentheses
}
    break;
...
#line 280 "yacc.y"
    {
    char temp[20];
    sprintf(temp, "t%d = %d", ++tempCount, (yyvsp[(1) - (1)]));
    addIntermediateCode(temp);
    (yyval) = tempCount;
    tempValues[tempCount] = (yyvsp[(1) - (1)]); // Store the value of the number
}
    break;
